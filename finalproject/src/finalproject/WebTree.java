...
public class WebTree {
	...
	public void setPostOrderScore(ArrayList<Keyword> keywords) throws IOException{//KeywordList
		setPostOrderScore(root, keywords);
	}
	
	private void setPostOrderScore(WebNode startNode, ArrayList<Keyword> keywords) throws IOException{//KeywordList
		//1.compute the score of children nodes postorder
		for(WebNode child : startNode.children){
			setPostOrderScore(child,keywords);
		}
